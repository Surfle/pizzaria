...
class ProdutoControllerTest {
    ...
    void testInclude() {
        ...
        when(produtoService.include(produtoDTOSimulado)).thenReturn(produtoDTOSimulado);

        ResponseEntity<ProdutoDto> resultado = produtoController.include(produtoDTOSimulado);
